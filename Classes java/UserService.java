 ...
 * 		Si dans une servlet on appel 50 fois une méthode dao, si on modifie la méthode dao
 ...
 * 
 * 
 * C'est dans cette couche qu'on va appliquer ddezs traitements spécifiques à l'objet user propre à notre projet

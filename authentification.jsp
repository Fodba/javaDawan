...
%>
		...
		<hr>
		<hr>
		<form action="InsertServlet" method="post" style="width: 100px;position:relative; left: 48%; ">
			<div style = "margin-top: 10px;">
				<label for="mail" >Email :</label> 
				<input type="email" name="mail" id="mail" placeholder="Saisir votre email" >
			</div>
			<div style = "margin-top: 10px;">
			...
			<div style = "margin-top: 10px;">
				...
				<input type="password" name="pwd" id="pwd" placeholder="Saisir le mot de passe">
			</div>
			<input type="submit" value="Envoyer la requête" style ="margin-top: 10px;">
		</form>
	...
	<div>
	<form action="" method="post" style="width: 100px;position:relative; left: 48%; ">
			<div style = "margin-top: 10px;">
				<label for="updateMail" >Email :</label> 
				<input type="email" name="updateMail" id="updateMail" placeholder="Modifier votre email" >
			</div>
			<div style = "margin-top: 10px;">
				<label for="updateNom" >Nom :</label> 
				<input type="text" name="updateNom" id="updateNom" placeholder="Modifier votre nom" >
			</div>
			<div style = "margin-top: 10px;">
				<label for="updatePwd">Password :</label> 
				<input type="password" name="updatePwd" id="updatePwd" placeholder="Changez votre mot de passe">
			</div>
			<input type="submit" value="Envoyer la requête" style ="margin-top: 10px;">
		</form>
        ...
        <tbody>
            <c:forEach items="${users}" var="user">
                <tr style ="border: 1px solid black; padding: 30px;">
                    ...
                    <td style ="border: 1px solid black;"><a href="CrudServlet?action=update&id=${user.id}">Modifier</a> ||  
                    <a href="CrudServlet?action=delete">Supprimer</a>   
                    </td>
                </tr>
            </c:forEach>
